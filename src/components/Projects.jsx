    ...
    return (
        <div  >
            ...
            <div id='projects' className=' pt-32'>
                ...
                <h2 className='text-white text-center  text-lg sm:w-[450px] sm:mx-auto mx-10  mt-5'  > Here are my projects, listed from <span className='font-bold text-2xl text-blue-500'>newest</span> to <span className='font-bold text-2xl text-blue-500'>oldest</span>. I hope you can see my <span className='font-bold text-xl text-indigo-400'>growth</span> and everything I've learned along the way! 🚀</h2>
